...
const STORE_DATA = {
  ...
  "Poorvika": { url: "https://www.poorvika.com/search?term=", domain: "poorvika.com" },
  ...
  "Myntra": { url: "https://www.myntra.com/", domain: "myntra.com", isPath: true }, // Myntra usually needs specific path or just home
...
async function fetchAlkartAIResults(product) {
  ...
  const getSearchUrl = (storeName, query) => {
    const store = STORE_DATA[storeName];
    if (!store) return "https://google.com/search?q=" + encodeURIComponent(query);
    const encodedQuery = encodeURIComponent(query);
    return store.url + encodedQuery;
  };

  // Mock STORE_RESULTS expanded for max coverage with DYNAMIC DEEP LINKS
  const STORE_RESULTS = [
    { name: product, store: "Flipkart", price: 12999, stock: "In stock", delivery: "Free delivery by Tomorrow", buyUrl: getSearchUrl("Flipkart", product) },
    { name: product, store: "Amazon India", price: 13200, stock: "In stock", delivery: "FREE Delivery", buyUrl: getSearchUrl("Amazon India", product) },
    { name: product, store: "JioMart", price: 12499, stock: "In stock", delivery: "Free delivery", buyUrl: getSearchUrl("JioMart", product) },
    { name: product, store: "Reliance Digital", price: 12999, stock: "In stock", delivery: "Ship to home", buyUrl: getSearchUrl("Reliance Digital", product) },
    { name: product, store: "Croma", price: 13000, stock: "In stock", delivery: "Express Shipping", buyUrl: getSearchUrl("Croma", product) },
    { name: product, store: "Vijay Sales", price: 12750, stock: "In stock", delivery: "Free shipping", buyUrl: getSearchUrl("Vijay Sales", product) },
    { name: product, store: "Poorvika", price: 12500, stock: "Available", delivery: "Free same day delivery", buyUrl: getSearchUrl("Poorvika", product) },
    { name: product, store: "Tata Cliq", price: 13500, stock: "In stock", delivery: "Standard delivery", buyUrl: getSearchUrl("Tata Cliq", product) },
    { name: product, store: "Sangeetha Mobiles", price: 12699, stock: "In stock", delivery: "Store pickup available", buyUrl: getSearchUrl("Sangeetha Mobiles", product) },
    { name: product, store: "Samsung India", price: 12999, stock: "In stock", delivery: "Official Store", buyUrl: getSearchUrl("Samsung India", product) },
    { name: product, store: "Snapdeal", price: 11999, stock: "In stock", delivery: "Free Shipping", buyUrl: getSearchUrl("Snapdeal", product) },
    { name: product, store: "AddmeCart", price: 10750, stock: "In stock", delivery: "Free delivery", buyUrl: "https://www.google.com/search?q=" + encodeURIComponent(product) }
  ];
